...
# image_paths = [
#     '../frontend/src/images/dashboard/timeseries-bar/1-left.png',
#     '../frontend/src/images/dashboard/timeseries-bar/1-right.png',
#     '../frontend/src/images/dashboard/timeseries-bar/2-left.png',
#     '../frontend/src/images/dashboard/timeseries-bar/2-right.png',
# ]
