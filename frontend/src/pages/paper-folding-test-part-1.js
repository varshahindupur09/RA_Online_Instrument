...
const PaperFoldingPart1Questions = () => {
    ...
    const handleNext = () => {
        navigate("/proceed-to-part2-proceed-to-part2-paper-folding-test");
    };

    const handleTimerCompletion = () => {
        navigate("/proceed-to-part2-proceed-to-part2-paper-folding-test"); //if a breather is needed in between we can add it 
    };
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await fetch(`${API_BASE_URL}/paperFoldingTest1`, {
                method: 'POST',
                headers: {
            ...
            <form onSubmit={handleSubmit}>
                <div name="instructions">
                    ...
                    <div className="radio-container">
                        <input type="radio" id="Part1Question1Answer1Option1" name="PartQuestion1Answer1" onChange={() => handleChange(1, "Option1")} />
                        <label htmlFor="Part1Question1Answer1Option1">
                            <img src={Part1Question1Answer1Option1} alt="Part1Question1Answer1Option1"/>
                        </label>
                        <br />
                        <input type="radio" id="Part1Question1Answer1Option2" name="PartQuestion1Answer1" onChange={() => handleChange(1, "Option2")} />
                        <label htmlFor="Part1Question1Answer1Option2">
                            <img src={Part1Question1Answer1Option2} alt="Part1Question1Answer1Option2" />
                        </label>
                        <br />
                        <input type="radio" id="Part1Question1Answer1Option3" name="PartQuestion1Answer1" onChange={() => handleChange(1, "Option3")} />
                        <label htmlFor="Part1Question1Answer1Option3">
                            <img src={Part1Question1Answer1Option3} alt="Part1Question1Answer1Option3" />
                        </label>
                        <br />
                        <input type="radio" id="Part1Question1Answer1Option4" name="PartQuestion1Answer1"onChange={() => handleChange(1, "Option4")} />
                        <label htmlFor="Part1Question1Answer1Option4">
                            <img src={Part1Question1Answer1Option4} alt="Part1Question1Answer1Option4" />
                        </label>
                        <br />
                        <input type="radio" id="Part1Question1Answer1Option5" name="PartQuestion1Answer1" onChange={() => handleChange(1, "Option5")} />
                    ...
                    <img src={Part1Question2} alt="Part1 Question2" />
                    <div className="radio-container">
                        <input type="radio" id="Part1Question2Answer2Option1" name="Part1Question2Answer2" onChange={() => handleChange(2, "Option1")}/>
                        <label htmlFor="Part1Question2Answer2Option1">
                            <img src={Part1Question2Answer2Option1} alt="Part1Question2Answer2Option1" />
                        </label>
                        <br />
                        <input type="radio" id="Part1Question1Answer1Option2" name="PartQuestion1Answer1" onChange={() => handleChange(2, "Option2")} />
                        <label htmlFor="Part1Question2Answer2Option2">
                            <img src={Part1Question2Answer2Option2} alt="Part1Question2Answer2Option2" />
                        </label>
                        <br />
                        <input type="radio" id="Part1Question2Answer2Option3" name="Part1Question2Answer2" onChange={() => handleChange(2, "Option3")} />
                        <label htmlFor="Part1Question2Answer2Option3">
                            <img src={Part1Question2Answer2Option3} alt="Part1Question2Answer2Option3" />
                        </label>
                        <br />
                        <input type="radio" id="Part1Question2Answer2Option4" name="Part1Question2Answer2" onChange={() => handleChange(2, "Option4")} />
                        <label htmlFor="Part1Question2Answer2Option4">
                            <img src={Part1Question2Answer2Option4} alt="Part1Question2Answer2Option4" />
                        </label>
                        <br />
                        <input type="radio" id="Part1Question2Answer2Option5" name="Part1Question2Answer2" onChange={() => handleChange(2, "Option5")} />
                    ...
                    <img src={Part1Question3} alt="Part1 Question3" />
                    <div className="radio-container">
                        <input type="radio" id="Part1Question3Answer3Option1" name="Part1Question3Answer3" onChange={() => handleChange(3, "Option1")} />
                        <label htmlFor="Part1Question3Answer3Option1">
                            <img src={Part1Question3Answer3Option1} alt="Part1Question3Answer3Option1" />
                        </label>
                        <br />
                        <input type="radio" id="Part1Question3Answer3Option2" name="Part1Question3Answer3" onChange={() => handleChange(3, "Option2")} />
                        <label htmlFor="Part1Question3Answer3Option2">
                            <img src={Part1Question3Answer3Option2} alt="Part1Question3Answer3Option2" />
                        </label>
                        <br />
                        <input type="radio" id="Part1Question3Answer3Option3" name="Part1Question3Answer3" onChange={() => handleChange(3, "Option3")}/>
                        <label htmlFor="Part1Question3Answer3Option3">
                            <img src={Part1Question3Answer3Option3} alt="Part1Question3Answer3Option3" />
                        </label>
                        <br />
                        <input type="radio" id="Part1Question3Answer3Option4" name="Part1Question3Answer3" onChange={() => handleChange(3, "Option4")}/>
                        <label htmlFor="Part1Question3Answer3Option4">
                            <img src={Part1Question3Answer3Option4} alt="Part1Question3Answer3Option4" />
                        </label>
                        <br />
                        <input type="radio" id="Part1Question3Answer3Option5" name="Part1Question3Answer3" onChange={() => handleChange(3, "Option5")} />
                    ...
                    <img src={Part1Question4} alt="Part1 Question4" />
                    <div className="radio-container">
                        <input type="radio" id="Part1Question4Answer4Option1" name="Part1Question4Answer4" onChange={() => handleChange(4, "Option1")} />
                        <label htmlFor="Part1Question4Answer4Option1">
                            <img src={Part1Question4Answer4Option1} alt="Part1Question4Answer4Option1" />
                        </label>
                        <br />
                        <input type="radio" id="Part1Question4Answer4Option2" name="Part1Question4Answer4" onChange={() => handleChange(4, "Option2")} />
                        <label htmlFor="Part1Question4Answer4Option2">
                            <img src={Part1Question4Answer4Option2} alt="Part1Question4Answer4Option2" />
                        </label>
                        <br />
                        <input type="radio" id="Part1Question4Answer4Option3" name="Part1Question4Answer4" onChange={() => handleChange(4, "Option3")} />
                        <label htmlFor="Part1Question4Answer4Option3">
                            <img src={Part1Question4Answer4Option3} alt="Part1Question4Answer4Option3" />
                        </label>
                        <br />
                        <input type="radio" id="Part1Question4Answer4Option4" name="Part1Question4Answer4" onChange={() => handleChange(4, "Option4")} />
                        <label htmlFor="Part1Question4Answer4Option4">
                            <img src={Part1Question4Answer4Option4} alt="Part1Question4Answer4Option4" />
                        </label>
                        <br />
                        <input type="radio" id="Part1Question4Answer4Option5" name="Part1Question4Answer4" onChange={() => handleChange(4, "Option5")} />
                    ...
                    <img src={Part1Question5} alt="Part1 Question5" />
                    <div className="radio-container">
                        <input type="radio" id="Part1Question5Answer5Option1" name="Part1Question5Answer5" onChange={() => handleChange(5, "Option1")} />
                        <label htmlFor="Part1Question5Answer5Option1">
                            <img src={Part1Question5Answer5Option1} alt="Part1Question5Answer5Option1" />
                        </label>
                        <br />
                        <input type="radio" id="Part1Question5Answer5Option2" name="Part1Question5Answer5" onChange={() => handleChange(5, "Option2")} />
                        <label htmlFor="Part1Question5Answer5Option2">
                            <img src={Part1Question5Answer5Option2} alt="Part1Question5Answer5Option2" />
                        </label>
                        <br />
                        <input type="radio" id="Part1Question5Answer5Option3" name="Part1Question5Answer5" onChange={() => handleChange(5, "Option3")} />
                        <label htmlFor="Part1Question5Answer5Option3">
                            <img src={Part1Question5Answer5Option3} alt="Part1Question5Answer5Option3" />
                        </label>
                        <br />
                        <input type="radio" id="Part1Question5Answer5Option4" name="Part1Question5Answer5" onChange={() => handleChange(5, "Option4")} />
                        <label htmlFor="Part1Question5Answer5Option4">
                            <img src={Part1Question5Answer5Option4} alt="Part1Question5Answer5Option4" />
                        </label>
                        <br />
                        <input type="radio" id="Part1Question5Answer5Option5" name="Part1Question5Answer5" onChange={() => handleChange(5, "Option5")} />
                    ...
                    <img src={Part1Question6} alt="Part1 Question6" />
                    <div className="radio-container">
                        <input type="radio" id="Part1Question6Answer6Option1" name="Part1Question6Answer6" onChange={() => handleChange(6, "Option1")} />
                        <label htmlFor="Part1Question6Answer6Option1">
                            <img src={Part1Question6Answer6Option1} alt="Part1Question6Answer6Option1" />
                        </label>
                        <br />
                        <input type="radio" id="Part1Question6Answer6Option2" name="Part1Question6Answer6" onChange={() => handleChange(6, "Option2")} />
                        <label htmlFor="Part1Question6Answer6Option2">
                            <img src={Part1Question6Answer6Option2} alt="Part1Question6Answer6Option2" />
                        </label>
                        <br />
                        <input type="radio" id="Part1Question6Answer6Option3" name="Part1Question6Answer6" onChange={() => handleChange(6, "Option3")} />
                        <label htmlFor="Part1Question6Answer6Option3">
                            <img src={Part1Question6Answer6Option3} alt="Part1Question6Answer6Option3" />
                        </label>
                        <br />
                        <input type="radio" id="Part1Question6Answer6Option4" name="Part1Question6Answer6" onChange={() => handleChange(6, "Option4")} />
                        <label htmlFor="Part1Question6Answer6Option4">
                            <img src={Part1Question6Answer6Option4} alt="Part1Question6Answer6Option4" />
                        </label>
                        <br />
                        <input type="radio" id="Part1Question6Answer6Option5" name="Part1Question6Answer6" onChange={() => handleChange(6, "Option5")} />
                    ...
                    <img src={Part1Question7} alt="Part1 Question7" />
                    <div className="radio-container">
                        <input type="radio" id="Part1Question7Answer7Option1" name="Part1Question7Answer7" onChange={() => handleChange(7, "Option1")} />
                        <label htmlFor="Part1Question7Answer7Option1">
                            <img src={Part1Question7Answer7Option1} alt="Part1Question7Answer7Option1" />
                        </label>
                        <br />
                        <input type="radio" id="Part1Question7Answer7Option2" name="Part1Question7Answer7" onChange={() => handleChange(7, "Option2")} />
                        <label htmlFor="Part1Question7Answer7Option2">
                            <img src={Part1Question7Answer7Option2} alt="Part1Question6Answer6Option2" />
                        </label>
                        <br />
                        <input type="radio" id="Part1Question7Answer7Option3" name="Part1Question7Answer7" onChange={() => handleChange(7, "Option3")} />
                        <label htmlFor="Part1Question7Answer7Option3">
                            <img src={Part1Question7Answer7Option3} alt="Part1Question7Answer7Option3" />
                        </label>
                        <br />
                        <input type="radio" id="Part1Question7Answer7Option4" name="Part1Question7Answer7" onChange={() => handleChange(7, "Option4")} />
                        <label htmlFor="Part1Question7Answer7Option4">
                            <img src={Part1Question7Answer7Option4} alt="Part1Question7Answer7Option4" />
                        </label>
                        <br />
                        <input type="radio" id="Part1Question7Answer7Option5" name="Part1Question7Answer7" onChange={() => handleChange(7, "Option5")} />
                    ...
                    <img src={Part1Question8} alt="Part1 Question8" />
                    <div className="radio-container">
                        <input type="radio" id="Part1Question8Answer8Option1" name="Part1Question8Answer8" onChange={() => handleChange(8, "Option1")} />
                        <label htmlFor="Part1Question8Answer8Option1">
                            <img src={Part1Question8Answer8Option1} alt="Part1Question8Answer8Option1" />
                        </label>
                        <br />
                        <input type="radio" id="Part1Question8Answer8Option2" name="Part1Question8Answer8" onChange={() => handleChange(8, "Option2")} />
                        <label htmlFor="Part1Question8Answer8Option2">
                            <img src={Part1Question8Answer8Option2} alt="Part1Question8Answer8Option2" />
                        </label>
                        <br />
                        <input type="radio" id="Part1Question8Answer8Option3" name="Part1Question8Answer8" onChange={() => handleChange(8, "Option3")} />
                        <label htmlFor="Part1Question8Answer8Option3">
                            <img src={Part1Question8Answer8Option3} alt="Part1Question8Answer8Option3" />
                        </label>
                        <br />
                        <input type="radio" id="Part1Question8Answer8Option4" name="Part1Question8Answer8"onChange={() => handleChange(8, "Option4")} />
                        <label htmlFor="Part1Question8Answer8Option4">
                            <img src={Part1Question8Answer8Option4} alt="Part1Question8Answer8Option4" />
                        </label>
                        <br />
                        <input type="radio" id="Part1Question8Answer8Option5" name="Part1Question8Answer8" onChange={() => handleChange(8, "Option5")} />
                    ...
                    <img src={Part1Question9} alt="Part1 Question9" />
                    <div className="radio-container">
                        <input type="radio" id="Part1Question9Answer9Option1" name="Part1Question9Answer9" onChange={() => handleChange(9, "Option1")} />
                        <label htmlFor="Part1Question9Answer9Option1">
                            <img src={Part1Question9Answer9Option1} alt="Part1Question9Answer9Option1" />
                        </label>
                        <br />
                        <input type="radio" id="Part1Question9Answer9Option2" name="Part1Question9Answer9" onChange={() => handleChange(9, "Option2")} />
                        <label htmlFor="Part1Question9Answer9Option2">
                            <img src={Part1Question9Answer9Option2} alt="Part1Question9Answer9Option2" />
                        </label>
                        <br />
                        <input type="radio" id="Part1Question9Answer9Option3" name="Part1Question9Answer9" onChange={() => handleChange(9, "Option3")} />
                        <label htmlFor="Part1Question9Answer9Option3">
                            <img src={Part1Question9Answer9Option3} alt="Part1Question9Answer9Option3" />
                        </label>
                        <br />
                        <input type="radio" id="Part1Question9Answer9Option4" name="Part1Question9Answer9" onChange={() => handleChange(9, "Option4")} />
                        <label htmlFor="Part1Question9Answer9Option4">
                            <img src={Part1Question9Answer9Option4} alt="Part1Question9Answer9Option4" />
                        </label>
                        <br />
                        <input type="radio" id="Part1Question9Answer9Option5" name="Part1Question9Answer9" onChange={() => handleChange(9, "Option5")} />
                    ...
                    <img src={Part1Question10} alt="Part1 Question10" />
                    <div className="radio-container">
                        <input type="radio" id="Part1Question10Answer10Option1" name="Part1Question10Answer10" onChange={() => handleChange(10, "Option1")} />
                        <label htmlFor="Part1Question10Answer10Option1">
                            <img src={Part1Question10Answer10Option1} alt="Part1Question10Answer10Option1" />
                        </label>
                        <br />
                        <input type="radio" id="Part1Question10Answer10Option2" name="Part1Question10Answer10" onChange={() => handleChange(10, "Option2")} />
                        <label htmlFor="Part1Question10Answer10Option2">
                            <img src={Part1Question10Answer10Option2} alt="Part1Question10Answer10Option2" />
                        </label>
                        <br />
                        <input type="radio" id="Part1Question10Answer10Option3" name="Part1Question10Answer10" onChange={() => handleChange(10, "Option3")} />
                        <label htmlFor="Part1Question10Answer10Option3">
                            <img src={Part1Question10Answer10Option3} alt="Part1Question10Answer10Option3" />
                        </label>
                        <br />
                        <input type="radio" id="Part1Question10Answer10Option4" name="Part1Question10Answer10" onChange={() => handleChange(10, "Option4")} />
                        <label htmlFor="Part1Question10Answer10Option4">
                            <img src={Part1Question10Answer10Option4} alt="Part1Question10Answer10Option4" />
                        </label>
                        <br />
                        <input type="radio" id="Part1Question10Answer10Option5" name="Part1Question10Answer10" onChange={() => handleChange(10, "Option5")} />
